...
//Following OID and codepoint specs from here - https://github.com/open-quantum-safe/oqs-provider/blob/main/ALGORITHMS.md#:~:text=1.3.6.1.4.1.2.267.7.8.7
...
func (*scheme) TLSIdentifier() uint   { return 0xfea5 /* temp */ }
func (*scheme) SupportsContext() bool { return false }
func (*scheme) Oid() asn1.ObjectIdentifier {
	return asn1.ObjectIdentifier{1, 3, 6, 1, 4, 1, 2, 267, 7, 8, 7}
}
