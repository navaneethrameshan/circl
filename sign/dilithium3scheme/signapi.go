...
//Following OID and codepoint specs from here - https://github.com/open-quantum-safe/oqs-provider/blob/main/ALGORITHMS.md#:~:text=1.3.6.1.4.1.2.267.7.6.5
...
func (*scheme) TLSIdentifier() uint   { return 0xfea3 /* temp */ }
